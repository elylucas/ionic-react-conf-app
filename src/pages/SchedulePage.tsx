...
class SchedulePage extends Component<Props, State> {
  ...
  ionViewWillEnter() {
    console.log('ionViewWillEnter from Schedule Page!');
  }

  ionViewDidEnter() {
    console.log('ionViewDidEnter from Schedule Page!');
  }

  ionViewWillLeave() {
    console.log('ionViewWillLeave from Schedule Page!');
  }

  ionViewDidLeave() {
    console.log('ionViewDidLeave from Schedule Page!');
  }
